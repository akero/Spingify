...
public class ServersActivity extends SherlockActivity implements ServiceConnection, ServerListener, OnItemClickListener, OnItemLongClickListener {
    ...
    public void logout(){
    	...
    	File file = new File(dir, "isloggedin.txt");
    	boolean deleted = file.delete();
    	Log.d(Boolean.toString(deleted),"tagd");}catch(Exception e){Log.d(e.toString(),"tagd");}
    	
    	Intent in =  new Intent(ServersActivity.this,org.yaaic.MainActivity.class);
		startActivity(in);
